<header>
    ...
    <nav>
        <a href="/public/index.php">Acceuil</a> <!-- Chemin absolu -->
        <a href="/src/views/annonce.php">Annonces</a> <!-- Chemin absolu -->
        <a href="/src/views/about.php">A propos</a> <!-- Chemin absolu -->
        <a href="/src/views/contact.php">Nous contacter</a> <!-- Chemin absolu -->
